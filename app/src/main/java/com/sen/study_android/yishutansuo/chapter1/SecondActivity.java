...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.lift_circle_text).getViewTreeObserver().addOnDrawListener(new ViewTreeObserver.OnDrawListener() {
            @Override
            public void onDraw() {
                Log.e(tag, "addOnDrawListener : "+findViewById(R.id.lift_circle_text).getWidth());
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.e(tag, "onConfigurationChanged:"+newConfig.toString()+findViewById(R.id.lift_circle_text).getWidth());
